# Dashboard – E-commerce Funnel Analysis (Power BI)

## Overview

This dashboard presents an end-to-end analysis of user behavior in an e-commerce funnel, tracking how users move from views → wishlist → cart → purchase.

The goal of this dashboard is to understand conversion patterns, drop-offs, and user intent behavior to identify optimization opportunities in the customer journey.
...
A funnel visualization showing user progression:
...
## Dashboard Preview
<img width="610" height="339" alt="Funnel Analysis" src="https://github.com/user-attachments/assets/0ca34c4e-7b2a-4cb4-914a-78791052fe9a" />

---

🚀 Outcome

This dashboard transforms raw event data into actionable insights, helping stakeholders understand where users drop off and how conversion can be improved.
